...
<div class="row">
    <div class="col-md-8">
        <h2>Detail Pegawai: {{ $pegawai->nama_pegawai }}</h2>
        @if (session('success'))
...
<div class="row">
    <div class="col-md-8">
        <a href="{{ route('pegawai.edit', $pegawai->id) }}" class="btn btn-warning mb-3"><i class="fas fa-edit"></i> Edit</a>
                ...
                <table class="table table-hover table-fluid">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $pegawai->user->level->nama_level }}</td>
                        </tr>
                        <tr>
                            <td class="key">Tanggal Didaftarkan</td>
                            <td>{{ $pegawai->created_at->diffForHumans() . ', ' . $pegawai->created_at }}</td>
                        </tr>
                    </tbody>
                  </table>
            </div>
